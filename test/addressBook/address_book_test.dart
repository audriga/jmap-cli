...
void main() {
  group('CLI AddressBook tests', () {
    test('addressBook create', () async {
      final auth = jsonDecode(
        await File('test/data/credentials/auth_ietf.json').readAsString(),
      );

      final name = 'CLI AddressBook ${DateTime.now().millisecondsSinceEpoch}';
    ...
    test('addressBook get list', () async {
      final auth = jsonDecode(
        await File('test/data/credentials/auth_ietf.json').readAsString(),
      );
    ...
    test('addressBook changes', () async {
      final auth = jsonDecode(
        await File('test/data/credentials/auth_ietf.json').readAsString(),
      );
