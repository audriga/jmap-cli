...
class ChangesCalendarCommand extends BaseCommand {
  @override
  final name = 'changes';

  @override
  List<String> get aliases => ['calendar.changes'];

  @override
  final description = 'Get change information of calendar as JSON';

  ChangesCalendarCommand() {
    argParser.addOption(
      'state',
      help:
  ...
  Future<int> run() async {
    try {
      ...
      final changes = await CalendarUtil.changesCalendars(
        client: httpClient,
        accountId: AccountId(Id(accountId)),
